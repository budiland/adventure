...
@section('content')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Freight</p>
                    </div>
                    <p class="text-muted mt-3 mb-0"><span class="text-danger me-1"><i
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Highest Sales Amount </p>
                    </div>
                    <p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i
    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">Coba Analytics</h4>
                    ...
                    <div class="mt-3">
                        <div id="coba-chart" class="apex-charts" dir="ltr"></div>
                    </div>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
        </div> <!-- end col-->
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Sales Amount By Country</h4>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Sales Amount By City</h4>
    ...
    @push('script')
        ...
        <script>
            // foreach $factSales->salesamt append to array salesamt
            var salesamt = [
                @foreach ($factSales->salesamt as $salesamt)
                    {{ $salesamt }},
                @endforeach
            ];
            // foreach $factSales->name append to array columnname
            var columnname = [
                @foreach ($factSales->name as $name)
                    '{{ $name }}',
                @endforeach
            ];
        </script>
        <script>
            ...
            // chart rendered on html tag with id coba-chart
            var chart = new ApexCharts(document.querySelector("#coba-chart"), options);
